...
export const purchaseInvoiceDefinition: DocumentDefinition = {
  ...
  fetchAndBuild: async ({ entityId, locale, direction, paperProfileId }) => {
    ...
    sections.push({
      ...
      title: 'البنود',
      columns: [
        { key: 'product', label: 'المنتج', align: 'start', width: '30%' },
        { key: 'sku', label: 'SKU', align: 'start', dir: 'ltr', width: '12%' },
        { key: 'unit', label: 'الوحدة', align: 'center', width: '8%' },
        { key: 'ordered_qty', label: 'الكمية', align: 'center', width: '10%' },
        { key: 'received_qty', label: 'المستلم', align: 'center', width: '10%' },
        { key: 'price', label: 'السعر', align: 'center', width: '10%' },
        { key: 'discount', label: 'خصم', align: 'center', width: '6%' },
        { key: 'tax', label: 'ضريبة', align: 'center', width: '6%' },
        { key: 'total', label: 'الإجمالي', align: 'end', width: '8%' },
      ],
      rows
    });
