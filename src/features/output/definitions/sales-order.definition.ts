  ...
  fetchAndBuild: async ({ entityId, locale, direction, paperProfileId }) => {
    ...
    const finalSections: any[] = [
      ...
      },
      {
        ...
        title: 'بنود الطلب',
        columns: [
          { key: 'product', label: 'المنتج / الصنف', width: '30%' },
          { key: 'sku', label: 'SKU', dir: 'ltr', width: '12%' },
          { key: 'qty', label: 'الكمية', align: 'center', width: '10%' },
          { key: 'delivered', label: 'مُسلّم', align: 'center', width: '8%' },
          { key: 'returned', label: 'مرتجع', align: 'center', width: '8%' },
          { key: 'price', label: 'سعر الوحدة', align: 'start', width: '10%' },
          { key: 'discount', label: 'خصم', align: 'start', width: '7%' },
          { key: 'tax', label: 'ضريبة', align: 'start', width: '7%' },
          { key: 'total', label: 'الإجمالي', align: 'start', width: '8%' },
        ],
        rows
      }
    ];
