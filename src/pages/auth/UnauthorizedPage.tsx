  ...
  return (
    <div className="ep-root">
      <div className="ep-card">
        {/* Icon */}
        <div className="ep-icon-wrap ep-icon-danger">
          <ShieldX size={44} strokeWidth={1.5} />
        </div>

        {/* Code badge */}
        <div className="ep-code">403</div>

        <h1 className="ep-title">غير مصرح بالوصول</h1>
        <p className="ep-desc">
        ...
        <div className="ep-actions">
          <button className="ep-btn-primary" onClick={() => navigate('/', { replace: true })}>
