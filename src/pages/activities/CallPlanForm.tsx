/**
 * CallPlanForm — إنشاء خطة مكالمات يومية
 * يُستدعى من /activities/call-plans/new
 */
import { useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { toast } from 'sonner'
import { useCreateCallPlan, useCurrentEmployee } from '@/hooks/useQueryHooks'
import type { CallPlanInput } from '@/lib/types/activities'
import PageHeader from '@/components/shared/PageHeader'
import Button from '@/components/ui/Button'

export default function CallPlanForm() {
  ...
  return (
    <div className="page-container animate-enter">
      <PageHeader
        ...
        subtitle="إنشاء خطة مكالمات يومية"
        breadcrumbs={[
      ...
      <form className="edara-card plan-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="ملاحظات على خطة المكالمات..."
          />
        </div>

        <p className="plan-form-hint">
          💡 بعد الإنشاء ستتمكن من إضافة العملاء وبنود المكالمات التفصيلية من صفحة الخطة
        </p>

        <div className="plan-form-actions">
          <Button type="button" variant="secondary" onClick={() => navigate('/activities/call-plans')} disabled={saving}>
            إلغاء
          </Button>
