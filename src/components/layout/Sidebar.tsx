...
const sections: NavSection[] = [
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: 'استبيانات الزيارات', path: '/activities/checklists',            permission: PERMISSIONS.CHECKLISTS_MANAGE },
          { label: 'أنواع الأنشطة',       path: '/activities/types',                 permission: PERMISSIONS.SETTINGS_UPDATE },
          { label: 'أنواع الأهداف',       path: '/activities/target-types',          permission: PERMISSIONS.SETTINGS_UPDATE },
        ],
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: 'hr', label: 'الشئون الإدارية', icon: UserCog,
        children: [
          ...
          { label: 'الحضور',          path: '/hr/attendance',         permission: PERMISSIONS.HR_ATTENDANCE_READ },
