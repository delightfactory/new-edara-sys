-- 120_fix_overdue_sales_invoices_rpc_ambiguity.sql
-- Purpose:
--   Fix PL/pgSQL ambiguity in get_overdue_sales_invoices caused by RETURNS TABLE
--   output names overlapping CTE column names.
